...
class pruebas(unittest.TestCase):
    ...
    def test_integration4_module_1_2(self):
        programa = Programa()
        tarjeta = "001234"
        valor1 = programa.modulo_1_verificar_tarjeta(tarjeta)
        valor2 = False
    ...
    #Si la tarjeta es válida(empleado) y  todos los datos de día y hora son permitidos para el empleado, se permite el acceso, se realiza el pago
    def test_integration5_module_1_2_3(self):
        programa = Programa()
        tarjeta = ["3412345", "AAA", 1.0]
        valor1 = programa.modulo_1_verificar_tarjeta(tarjeta[0])
        valor2 = True
        self.assertEqual(valor1[0], valor2) #Verifica que la tarjeta es válida

        valor3 = programa.modulo_2_acceso_valido(valor1[1], 4, 10)
        valor4 = True
        self.assertEqual(valor3, valor4) # Verifica que el acceso fue concedido

        valor5 = programa.modulo_3_sistema_pagos(tarjeta, 5)
        valor6 = "Pasaje cobrado exitosamente"
        self.assertEqual(valor5, valor6)

    #Si la tarjeta es inválida y  todos los datos de día y hora son permitidos para el empleado, no se permite el acceso, no se realiza el pago
    def test_integration6_module_1_2_3(self):
        programa = Programa()
        tarjeta = ["a", "AAA", 1.0]
        valor1 = programa.modulo_1_verificar_tarjeta(tarjeta[0])
        valor2 = False
        self.assertEqual(valor1[0], valor2) #Verifica que la tarjeta es  noválida
        ...
        valor5 = programa.modulo_3_sistema_pagos(tarjeta, 5)
        valor6 = "No se pudo cobrar el pasaje"
        self.assertEqual(valor5, valor6)
